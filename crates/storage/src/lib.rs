...
pub use relational::{
    ...
    encode_relational_wal_batch, relational_index_recovery_delta_file,
    relational_index_shadow_artifact_file, RelationalCheckpoint, RelationalColumnSchema,
    RelationalComparisonOp, RelationalConflictAction, RelationalDecodeLimits, RelationalError,
    RelationalForeignKeySchema, RelationalHydrationBudget, RelationalIndexChange,
    ...
    RelationalIndexRecoveryReport, RelationalIndexRootDescriptor, RelationalIndexSchema,

...
pub use relational::{
    ...
    encode_relational_wal_batch, relational_index_shadow_artifact_file, RelationalCheckpoint,
    ...
    RelationalIndexRootDescriptor, RelationalIndexSchema, RelationalIndexShadowBuildReport,
    ...
    RelationalMutationLimits, RelationalOverflowConfig, RelationalOverflowRef, RelationalPredicate,
    ...
    DEFAULT_RELATIONAL_OVERFLOW_THRESHOLD_BYTES, RELATIONAL_INDEX_SHADOW_MANIFEST_FILE,
};
pub use scan::{

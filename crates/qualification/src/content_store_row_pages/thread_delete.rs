...
use skein::{
    Database, DatabaseConfig, DatabaseTransaction, DurabilityPolicy, QueryOutput,
    QueryStreamOptions, Result, SkeinError, Value,
};
...
fn stage_thread_delete(
    ...
    for document_id in &document_ids {
        anchor_count = anchor_count
            ...
            .ok_or_else(|| SkeinError::Execution("anchor count overflow".to_string()))?;
    }
...
fn delete_phase_error(phase: &str, error: SkeinError) -> SkeinError {

...
| Typed columnar batches, numeric vectorized fragments, morsel admission, fallback, and performance evidence | [`VECTORIZED_MORSEL_EXECUTION_SPEC.md`](VECTORIZED_MORSEL_EXECUTION_SPEC.md) | [`../ARCHITECTURE.md`](../ARCHITECTURE.md), [`EMBEDDED_RUNTIME_SPEC.md`](EMBEDDED_RUNTIME_SPEC.md) |

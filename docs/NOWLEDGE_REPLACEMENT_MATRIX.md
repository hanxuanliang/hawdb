...
`system.search_projection_changefeed`. The duplicate typed introspection
getters are no longer public integration surfaces. Recovery, admission,
generation publication, and grouped mutation contracts remain typed.

...
- [ ] Complete the query-first public API convergence.
  ...
  - Prioritize the remaining read-only schema-migration, Source, Thread, and
    Skill facades after their host queries have bounded row/payload contracts
    and pinned-snapshot coverage.

...
pub use api::{
    ...
    KnowledgeSourceParsedMetadataUpdate, KnowledgeSourceReferenceEntityListOutput,
    KnowledgeSourceReferenceEntityListRequest, KnowledgeSourceReferenceEntityRow,

...
pub use api::{
    ...
    KnowledgeMemoryAccessBatchRow, KnowledgeMemoryAccessTouch, KnowledgeMemoryLifecycleBatchOutput,
    KnowledgeMemoryLifecycleBatchRequest, KnowledgeMemoryLifecycleBatchRow,
    KnowledgeMemoryLifecycleUpdate, KnowledgeNeighborDirection, KnowledgeNeighborsOutput,
    ...
    KnowledgeRetrieverCandidate, KnowledgeRetrieverReport, KnowledgeScopedEntityBatchRequest,

...
pub use api::{
    ...
    KnowledgeMemoryEvolvesNeighborRow, KnowledgeMemoryLabelDeleteOutput,
    ...
    KnowledgeMemoryPrefixOwnershipRow, KnowledgeMemorySourceAttributionOutput,
    KnowledgeMemorySourceAttributionRequest, KnowledgeMemorySourceAttributionRow,
    KnowledgeMemoryTitleContentOutput, KnowledgeMemoryTitleContentRequest,
    KnowledgeMemoryTitleContentRow, KnowledgeNeighborDirection, KnowledgeNeighborsOutput,
    KnowledgeNeighborsRequest, KnowledgeNormalizedSpaceMoveBatchOutput,

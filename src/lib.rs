...
pub use api::{
    ...
    KnowledgeGraphPathDirection, KnowledgeGraphSeed, KnowledgeMemoryAccessBatchOutput,
    ...
    KnowledgePropertyBatchRequest, KnowledgePropertyRow, KnowledgePropertyUpdateBatchOutput,
    KnowledgePropertyUpdateBatchRequest, KnowledgePropertyUpdateBatchRow,
    KnowledgePropertyUpdateOutput, KnowledgePropertyUpdateRequest,
    ...
    KnowledgeScopedSubgraphRequest, KnowledgeSkillUsageStatsBatchOutput,

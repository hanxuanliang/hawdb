...
pub use nowledge_mem::{
    ...
    NowledgeMemRetrievalOutput, NowledgeMemRetrievalReport, NowledgeMemRouteReadinessSummary,
    ...
    NOWLEDGE_MEM_SEARCH_CANDIDATE_TRACE_SHADOW_ENGINE, REQUIRED_NOWLEDGE_MEM_BOUNDED_READ_ROUTES,
};
pub use qos::{

...
pub use api::{
    ...
    KnowledgeMemoryContentUpdate, KnowledgeMemoryEntityGroup, KnowledgeMemoryEntityListOutput,
    KnowledgeMemoryEntityListRequest, KnowledgeMemoryEntityRow, KnowledgeMemoryEvolvesLatestOutput,

...
pub use nowledge_mem::{
    ...
    NowledgeMemReadOutput, NowledgeMemReadReport, NowledgeMemReadinessAreaMap,
    ...
    NowledgeMemSearchProjectionRole, NowledgeMemSlowQueryRecord, NowledgeMemSlowQueryReport,

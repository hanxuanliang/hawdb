...
pub use nowledge_mem::{
    ...
    NowledgeMemSearchCandidateOutput, NowledgeMemSearchCandidateReport,
    ...
    NOWLEDGE_MEM_SEARCH_CANDIDATE_PRIMARY_ENGINE, NOWLEDGE_MEM_SEARCH_CANDIDATE_REPORT_PROTOCOL,

...
pub use api::{
    ...
    KnowledgeRelationshipGroup, KnowledgeRelationshipsOutput, KnowledgeRelationshipsRequest,
    ...
    KnowledgeScopedRelationshipDeleteRequest, KnowledgeScopedRelationshipsRequest,

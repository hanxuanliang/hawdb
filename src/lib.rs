...
pub use api::{
    ...
    KnowledgeEntityOutput, KnowledgeEntityRequest, KnowledgeEntityUpsertBatchOutput,
    KnowledgeEntityUpsertBatchRequest, KnowledgeEntityUpsertBatchRow, KnowledgeEntityUpsertOutput,
    KnowledgeEntityUpsertRequest, KnowledgeEvidence, KnowledgeFallbackReasonCode,
    ...
    KnowledgeGraphPathDirection, KnowledgeGraphSeed, KnowledgeLabelLifecycleBatchOutput,

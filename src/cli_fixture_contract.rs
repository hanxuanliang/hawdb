use skein::compat::CypherExecutionMode;
use skein::{
    CompatibilityCheck, CompatibilityFixture, CypherFixtureStatement, ExpectedErrorClass,
    ExpectedRows, ProjectedGraphFixtureCheck, Value,
};
...
mod tests {
    ...
    fn renders_nowledge_fixture_contract_for_wrapper_shims() {
        let fixture = skein::nowledge_memory_core_fixture();
